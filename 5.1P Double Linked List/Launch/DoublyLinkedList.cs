...
namespace DoublyLinkedList
{
    public class DoublyLinkedList<T>
    {
        ...
        {
            if (node == null)   throw new NullReferenceException("Node not exist in list");
            Node<T> current = node as Node<T>;
            // if before it is HEAD then null : Previous NODE
            return current.Previous == Head ? null : current.Previous;  
        }

        public INode<T> AddFirst(T value)
        {
            Node<T> node = new Node<T>(value, Head, Head.Next); // HEAD <= NODE => HEAD.NEXT
        ...
        {
            if (before == null) throw new NullReferenceException("Null input node");
            Node<T> current = before as Node<T>;
        ...
        {
            if (after == null)  throw new NullReferenceException("Null input node");
            Node<T> current = after as Node<T>;
        ...
        public void Remove(INode<T> node)
        {
            ...
            if (current == null || current.Next == null || current.Previous == null)   
                throw new InvalidOperationException("Node not exist in list");
        ...
        public void RemoveFirst()
        {
            ...
            Head.Next = Head.Next.Next; // HEAD => HEAD.NEXT.NEXT
            Head.Next.Previous = Head;  // HEAD <=> HEAD.NEXT.NEXT
            Count--;
        }
        ...
        public void RemoveLast()
        {
            ...
            Node<T> current = Tail.Previous.Previous;
            current.Next = Tail;
